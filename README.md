...
|----------|------|----------|------|
| US02 | Dueño de un local | High | Gestión de Identidad y Acceso (IAM) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US03 | Usuario registrado (aprendiz o dueño de local) | High | Gestión de Identidad y Acceso (IAM) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US04 | Usuario autenticado | Medium | Gestión de Identidad y Acceso (IAM) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US05 | Usuario registrado | Medium | Gestión de Identidad y Acceso (IAM) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US06 | Nuevo aprendiz | High | Perfiles de Usuario (Profiles) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US07 | Aprendiz | Medium | Perfiles de Usuario (Profiles) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US08 | Aprendiz | Medium | Perfiles de Usuario (Profiles) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US09 | Usuario | Low | Perfiles de Usuario (Profiles) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US10 | Dueño de negocio (Partner) | High | Gestión de Locales (Partner) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US11 | Partner | Medium | Gestión de Locales (Partner) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US12 | Partner | Low | Gestión de Locales (Partner) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US13 | Partner | Low | Gestión de Locales (Partner) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US14 | Partner | Medium | Gestión de Locales (Partner) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US15 | Aprendiz | High | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US16 | Aprendiz | High | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US17 | Aprendiz | High | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US18 | Aprendiz | Medium | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US19 | Aprendiz | Medium | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US20 | Aprendiz | High | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US21 | Partner | Medium | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US22 | Aprendiz con una reserva | Low | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US23 | Aprendiz | Medium | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US24 | Aprendiz en una lista de espera | Medium | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US25 | Aprendiz que asistió a un encuentro | Low | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US26 | Aprendiz | Medium | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US27 | Aprendiz | Low | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US28 | Aprendiz | Medium | Gestión de Encuentros (Event) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US29 | Aprendiz | Medium | Lealtad y Gamificación (Loyalty) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US30 | Aprendiz | Low | Lealtad y Gamificación (Loyalty) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US31 | Aprendiz | Low | Lealtad y Gamificación (Loyalty) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US32 | Aprendiz | Low | Lealtad y Gamificación (Loyalty) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US33 | Aprendiz | Low | Lealtad y Gamificación (Loyalty) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US34 | Aprendiz leal | Low | Lealtad y Gamificación (Loyalty) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US35 | Aprendiz | Medium | Lealtad y Gamificación (Loyalty) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US36 | Partner | Medium | Analíticas (Analytics) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US37 | Partner | Medium | Analíticas (Analytics) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US38 | Partner | Medium | Analíticas (Analytics) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US39 | Partner | Low | Analíticas (Analytics) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US40 | Partner | Low | Analíticas (Analytics) |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US41 | Aprendiz | Medium | Comunidad y Social |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US42 | Aprendiz | Medium | Comunidad y Social |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US43 | Aprendiz | Low | Comunidad y Social |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US45 | Usuario | High | Notificaciones |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US46 | Usuario | Medium | Moderación |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US47 | Administrador | Medium | Administración |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US48 | Administrador | High | Administración |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US49 | Administrador | Medium | Administración |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US50 | Administrador | High | Administración |
...
| Story ID | User | Priority | Epic |
|----------|------|----------|------|
| US51 | Administrador | Low | Administración |
