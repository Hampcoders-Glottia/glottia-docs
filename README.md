...
| **TP1** | 07/10/2025  | **Ivo Marcelo Machado Bracamonte**            | Desarrollo de la landing page y aplicación móvil en Android. |
| **TB2** | 11/11/2025  | **Ethan Matías Aliaga Aguirre**               | Desarrollo del módulo **IAM (Identity & Access Management)** en la aplicación Kotlin. Creación del esquema general del código y estructura base de paquetes. Documentación del flujo de autenticación y arquitectura del proyecto. |
| **TB2** | 11/11/2025  | **Leandro Saúl Contreras López**              | Implementación del proyecto en **Flutter** para el análisis comparativo con Kotlin. Desarrollo de pantallas base y prueba de integración con la API del backend. Documentación del proceso técnico y evidencias de despliegue. |
| **TB2** | 11/11/2025  | **Ítalo Ludwing Sánchez Manrique**            | Desarrollo del módulo **Venue** en Kotlin, incluyendo los modelos, DTOs, repositorios y mapeadores. Conexión con endpoints del backend y pruebas de integración. Documentación del flujo de datos del contexto Venue. |
| **TB2** | 11/11/2025  | **Ivo Marcelo Machado Bracamonte**            | Implementación del módulo **Profile** dentro de la app Kotlin. Creación del modelo de datos, repositorio y conexión con el backend. Diseño de vistas y lógica para la gestión de perfiles de usuario. |
| **TF** | 02/12/2025  | **Ethan Matías Aliaga Aguirre**               | Coordinación general del avance del módulo en Flutter. Revisión técnica de la integración con el backend y validación del flujo de reservas y comunidad. Documentación del comportamiento esperado y soporte al equipo en arquitectura. |
| **TF** | 02/12/2025  | **Leandro Saúl Contreras López**              | Desarrollo en Flutter del módulo para **reservas de mesas**, incluyendo vistas, lógica y conexión con endpoints. Implementación de la pantalla para **ver comunidad** y pruebas funcionales del flujo completo. Documentación del progreso y evidencias. |
| **TF** | 02/12/2025  | **Ítalo Ludwing Sánchez Manrique**            | Integración del módulo Flutter con los servicios del backend. Ajustes en los endpoints relacionados a reservas y comunidad. Apoyo en pruebas de integración y revisión de consistencia de datos. |
| **TF** | 02/12/2025  | **Ivo Marcelo Machado Bracamonte**            | Diseño y mejora de interfaces en Flutter para reservas y comunidad. Optimización de la experiencia de usuario. Implementación de navegación y componentes visuales del nuevo módulo. |
...
### TB2 – Desarrollo de la aplicacion Mobile en Kotlin y Flutter 
Este entrega marcó una evolución significativa respecto al primero, pasando de una fase de diseño y prototipado a una etapa de implementación funcional y validación técnica integral.

Se observó un incremento en la frecuencia y consistencia de commits en comparación al Sprint 1.  
La colaboración se distribuyó de forma balanceada entre los módulos **móvil** y **backend**, con integración continua entre ambos repositorios.

<img src="https://i.postimg.cc/sfbmmwDT/imsigth2.png" alt="GitHub Insights Sprint 2" width="600"/>

>  **Análisis:**  
> El equipo mantuvo una dinámica de desarrollo ágil, con commits frecuentes, revisiones cruzadas y mejoras incrementales en la arquitectura técnica.  
> La base del ecosistema Glottia quedó consolidada para futuras iteraciones funcionales y pruebas de usuario.
...
En esta sección se evidencia cómo las actividades realizadas en el **Trabajo Final** han contribuido al desarrollo del **Outcome 7 de ABET – EAC**, referido a la *capacidad de adquirir y aplicar nuevos conocimientos según sea necesario, utilizando estrategias de aprendizaje apropiadas*. Cada integrante del equipo asumió responsabilidades que implicaron la búsqueda, asimilación y aplicación de nuevos conceptos, metodologías y herramientas propias de la Ingeniería de Software. Estas acciones fortalecieron la autonomía del aprendizaje y la habilidad de adaptarse a desafíos técnicos y metodológicos reales.

> *Adquiere y aplica nuevos conocimientos según sea necesario, utilizando estrategias de aprendizaje apropiadas.*

| **Criterio específico** | **Acciones realizadas** | **Conclusiones** |
|-------------------------|-------------------------|------------------|
| **Demuestra capacidad de adquirir y aplicar nuevos conocimientos según sea necesario.** | **Aliaga Aguirre, Ethan Matías**<br>- Investigó y redactó la **Descripción de la Startup** y **Perfiles de Integrantes del Equipo**, aplicando metodologías de documentación empresarial.<br>- Contribuyó en la **Especificación de Requerimientos (User Stories, Impact Mapping, Product Backlog)**, investigando buenas prácticas en gestión de requisitos.<br><br>**Contreras López, Leandro Saúl**<br>- Elaboró la sección de **Antecedentes y Problemática**, contextualizando la solución en el marco de la industria EdTech.<br>- Participó en el **Diseño de Entrevistas y Registro**, aplicando técnicas de levantamiento de información para identificar necesidades reales de los usuarios.<br><br>**Machado Bracamonte, Ivo Marcelo**<br>- Desarrolló los entregables de **Lean UX Process** (Problem Statements, Assumptions, Hypothesis, Canvas), aprendiendo a aplicar esta metodología centrada en el usuario.<br>- Contribuyó en la construcción de **User Personas** y **User Task Matrix**, profundizando en técnicas de experiencia de usuario.<br>- Colaboró en la elaboración de **Context Mapping** y **EventStorming**, asimilando conceptos de Domain-Driven Design.<br><br>**Sánchez Manrique, Italo Ludwing**<br>- Lideró el diseño de **User Journey Mapping y Empathy Mapping**, investigando métodos de análisis de experiencia de usuario.<br>- Contribuyó en la construcción de los **Bounded Context Canvases** y en el modelado de capas de DDD (Domain, Interface, Application, Infrastructure). | **TB1:** El equipo demostró su capacidad de **aprender de manera autónoma** para abordar nuevas metodologías (Lean UX, Domain-Driven Design, C4, Needfinding) y herramientas de modelado. La investigación y aplicación práctica de estos enfoques redujo la incertidumbre en el diseño de la solución, permitió consolidar una base conceptual sólida y garantizó que cada entregable esté alineado con buenas prácticas de Ingeniería de Software.<br><br>**TP (Trabajo Final):** Durante el TP, el equipo aplicó un enfoque de **aprendizaje continuo y aplicado**, profundizando en herramientas y tecnologías relacionadas con el desarrollo backend, el avance del aplicativo móvil, y la creación de prototipos, wireframes y mockups. Este proceso implicó la exploración de nuevos lenguajes, frameworks y técnicas de integración entre capas del sistema. El equipo fortaleció sus competencias técnicas y demostró la capacidad de **adaptarse rápidamente a nuevos desafíos tecnológicos**, integrando conocimientos adquiridos a lo largo del ciclo en una solución funcional y escalable. Además, la coordinación de pruebas, la integración entre módulos (Flutter, Kotlin, Backend) y la documentación técnica evidenciaron un aprendizaje activo y orientado a resolver problemas reales del proyecto.<br><br>**TB2:** En el segundo bloque, los integrantes mostraron una evolución significativa en su **aprendizaje autónomo**, abordando con profundidad aspectos de arquitectura, implementación y documentación técnica. Se afianzó el dominio de frameworks y herramientas como **Kotlin Multiplatform, Compose**, así como el uso avanzado de **Git** y prácticas de control de versiones colaborativo. Asimismo, el equipo reforzó sus habilidades en **arquitecturas modulares**, desacoplamiento de componentes y análisis técnico mediante **ADR (Architectural Decision Records)**. Este bloque consolidó la capacidad del equipo para **aprender mediante la práctica**, resolver problemas de integración y optimizar la calidad del código a través del trabajo colaborativo y reflexivo.<br><br>**TF:** En el avance TF, el equipo consolidó su capacidad de **aprender nuevas tecnologías móviles y aplicarlas inmediatamente**, particularmente en la implementación del módulo en **Flutter** para el segmento Aprendiz de Idiomas. Se desarrollaron funcionalidades clave como **reservas de mesas**, visualización de la **comunidad de usuarios** y flujos de interacción completos conectados al backend. Este avance implicó aprender widgets avanzados, manejo de estados, consumo de APIs y patrones de diseño móvil. Asimismo, el equipo integró principios de UX/UI, depuró errores de integración y fortaleció su comprensión del ecosistema multiplataforma. TF evidencia la madurez del equipo en aprender de forma autónoma, aplicar rápidamente nuevos conocimientos y adaptarse a un contexto técnico cambiante, demostrando un crecimiento continuo y orientado a la construcción de un producto más robusto. |
...
<img src = "https://i.postimg.cc/qvjKgZbj/1.png" />

<img src = "https://i.postimg.cc/8C77ckr6/2.png" />

<img src = "https://i.postimg.cc/vZNmJRSD/3.png" />

<img src = "https://i.postimg.cc/fRpwHcJL/4.png" />

<img src = "https://i.postimg.cc/fyzZ35gS/5.png" />
